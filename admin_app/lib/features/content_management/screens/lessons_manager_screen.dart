...
class _LessonsManagerScreenState extends ConsumerState<LessonsManagerScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_selectedClassNodeId == null && classOptions.isNotEmpty) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        if (mounted) {
          setState(() => _selectedClassNodeId = classOptions.isNotEmpty ? classOptions.first.id : null);
        }
      });
    }
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: _selectedSubjectId == null || _selectedClassNodeId == null
                    ? null
                    : () => _showChapterEditorModal(
                          ...
                          countryId: ref.read(nodesByTypeProvider('country')).valueOrNull?.isNotEmpty == true
                              ? ref.read(nodesByTypeProvider('country')).valueOrNull!.first.id
                              : null,
                        ),
            ...
            child: Wrap(
              ...
              children: [
                Row(
                  ...
                  children: [
                    const Icon(Icons.filter_list_rounded, color: AppTheme.accentBlue, size: 20),
          ...
          Expanded(
            child: _selectedSubjectId == null
                ...
                : chaptersAsync!.when(
                    data: (chapters) {
                      final visible =
                          chapters.where((c) => _matchesSearch(c, _searchQuery)).toList();
                      if (chapters.isEmpty) {
                        return Center(
                          child: Text(
  ...
  Widget _buildTermFolder(
    ...
    final activeLessonsCount = chapters.fold<int>(0, (sum, c) => sum + c.lessons.length);
  ...
  Widget _buildChapterCard(
    ...
    final className = chapter.classNodeId == null
        ? null
        : classOptions.where((c) => c.id == chapter.classNodeId).firstOrNull?.name;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: chapter.isActive ? AppTheme.primaryBorder : AppTheme.accentAmber.withValues(alpha: 0.4),
        ),
      ),
      child: Material(
        color: Colors.transparent,
        ...
        child: ExpansionTile(
            ...
            children: [
              Expanded(
                child: Text(
                  ...
                  style: GoogleFonts.outfit(
                    ...
                    decoration: chapter.isActive ? null : TextDecoration.lineThrough,
                  ),
                ),
              ),
              Container(
                ...
                child: Text(
                  ...
                  style: GoogleFonts.inter(
                    fontSize: 11,
                    color: className != null ? AppTheme.accentBlue : AppTheme.accentRose,
              ...
              if (termLabel != null) ...[
                Container(
                  ...
                  child: Text(
                    termLabel,
                    style: GoogleFonts.inter(fontSize: 11, color: AppTheme.accentIndigo, fontWeight: FontWeight.w600),
                  ),
                ),
              ],
              if (chapter.classNodeId != null)
                Consumer(
                  builder: (context, ref, _) {
                    final twinAsync = ref.watch(twinGroupForClassProvider(
                        (classNodeId: chapter.classNodeId, subjectId: chapter.subjectId)));
                    final twin = twinAsync.valueOrNull;
                    final siblings = twin?.members.where((m) => m.classNodeId != chapter.classNodeId).toList() ?? [];
                    ...
                    return Container(
                      ...
                      child: Text(
                        ...
                        overflow: TextOverflow.ellipsis,
                        style: GoogleFonts.inter(fontSize: 11, color: AppTheme.accentCyan, fontWeight: FontWeight.w600),
                      ),
                    );
                  },
                ),
              if (!chapter.isActive)
                Container(
                  ...
                  child: Text(
                    'ARCHIVÉ',
                    style: GoogleFonts.inter(fontSize: 10, color: AppTheme.accentAmber, fontWeight: FontWeight.bold),
                  ),
                ),
              Text(
          ...
          subtitle: chapter.introduction != null && chapter.introduction!.isNotEmpty
              ? Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (chapter.introMedia.isNotEmpty) ...[
                    Wrap(
                      ...
                      children: chapter.introMedia.map((m) {
                        return Chip(
                          avatar: const Icon(Icons.attach_file_rounded, size: 14, color: AppTheme.accentBlue),
                          label: Text(
                            m['filename'] as String? ?? m['url'] as String? ?? '',
                  ...
                  if (chapter.lessons.isEmpty)
                    ...
                    ...(_searchQuery.isEmpty || chapter.title.toLowerCase().contains(_searchQuery.toLowerCase())
                            ? chapter.lessons
                            : chapter.lessons
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      TextButton.icon(
                        ...
                        label: Text('Modifier', style: GoogleFonts.inter(color: AppTheme.accentBlue)),
                      ),
                      TextButton.icon(
                        onPressed: () => _showDuplicateChapterModal(context, chapter, classOptions),
                        icon: const Icon(Icons.copy_all_rounded, size: 16, color: AppTheme.accentIndigo),
                        label: Text(
                          'Dupliquer vers une autre classe',
                          style: GoogleFonts.inter(color: AppTheme.accentIndigo),
                        ),
                      ),
                      if (chapter.classNodeId != null)
                        Consumer(
                        ...
                        (classNodeId: chapter.classNodeId, subjectId: chapter.subjectId)));
                            final twin = twinAsync.valueOrNull;
                            final siblingCount =
                                twin?.members.where((m) => m.classNodeId != chapter.classNodeId).length ?? 0;
                            if (siblingCount == 0) return const SizedBox.shrink();
                            return TextButton.icon(
                              onPressed: () => _showDuplicateToTwinGroupModal(context, chapter, twin!),
                      ...
                      TextButton.icon(
                        ...
                        icon: Icon(
                          chapter.isActive ? Icons.archive_rounded : Icons.unarchive_rounded,
                          size: 16,
                          color: AppTheme.accentAmber,
                        ),
                        label: Text(
                          chapter.isActive ? 'Archiver ce chapitre' : 'Désarchiver ce chapitre',
                          style: GoogleFonts.inter(color: AppTheme.accentAmber),
                        ),
                      ),
                      if (!chapter.isActive)
                        TextButton.icon(
                          onPressed: () => _showPermanentDeleteChapterConfirmation(context, chapter),
                          icon: const Icon(Icons.delete_forever_rounded, size: 16, color: AppTheme.accentRose),
                          label: Text(
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(
            icon: const Icon(Icons.visibility_rounded, size: 18, color: AppTheme.accentEmerald),
            tooltip: 'Aperçu',
            padding: EdgeInsets.zero,
            constraints: const BoxConstraints(minWidth: 32, minHeight: 32),
          ...
          if (!lesson.isActive)
            IconButton(
              ...
              padding: EdgeInsets.zero,
              constraints: const BoxConstraints(minWidth: 32, minHeight: 32),
              onPressed: () => _showPermanentDeleteLessonConfirmation(context, lesson),
            ),
        ],
      ),
    );
  ...
  void _showDeactivateChapterConfirmation(BuildContext context, Chapter chapter) {
    ...
    _showConfirmActionDialog(
      ...
      onConfirm: () => service.deactivateChapterCascade(chapter.id, _currentAdminId()),
      successMessage: 'Chapitre "${chapter.title}" et ses leçons archivés.',
    );
  }

  void _showReactivateChapterConfirmation(BuildContext context, Chapter chapter) {
    final service = ref.read(supabaseServiceProvider);
    _showConfirmActionDialog(
      context,
      ...
      onConfirm: () => service.reactivateChapterCascade(chapter.id, _currentAdminId()),
      successMessage: 'Chapitre "${chapter.title}" et ses leçons désarchivés.',
    );
  }

  void _showPermanentDeleteChapterConfirmation(BuildContext context, Chapter chapter) {
    final service = ref.read(supabaseServiceProvider);
    _showConfirmActionDialog(
      context,
      ...
      onConfirm: () => service.permanentlyDeleteChapter(chapter.id, _currentAdminId()),
  ...
  void _showPermanentDeleteLessonConfirmation(BuildContext context, Lesson lesson) {
    final service = ref.read(supabaseServiceProvider);
    _showConfirmActionDialog(
      context,
      icon: Icons.delete_forever_rounded,
      ...
      confirmLabel: 'Supprimer définitivement',
      confirmColor: AppTheme.accentRose,
      onConfirm: () => service.permanentlyDeleteLesson(lesson.id, _currentAdminId()),
                  ...
                  children: [
                    ...
                    OutlinedButton.icon(
                      ...
                      onPressed: () => _showChapterStudentPreviewModal(
                        ...
                        className: classOptions.where((c) => c.id == selectedClassNodeId).firstOrNull?.name,
                            ...
                            children: [
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  helperText: selectedClassNodeId != null &&
                                          !classOptions.any((c) => c.id == selectedClassNodeId)
                                  ...
                                  return termsAsync.when(
                                    data: (terms) => Row(
                                      children: [
                                        Expanded(
                                          ...
                                          child: DropdownButtonFormField<String?>(
                                            ...
                                            items: [
                                              ...
                                              ...terms.where((t) => t.isActive || t.id == selectedTermId).map(
                                        ...
                                        IconButton(
                                          icon: const Icon(Icons.add_circle_outline_rounded, color: AppTheme.accentEmerald),
                                          tooltip: 'Créer un trimestre',
                                          onPressed: countryId == null
                                              ? null
                                              : () => _showCreateTermModal(context, countryId, (created) {
                                                    setModalState(() => selectedTermId = created.id);
                                                  }),
                                        ),
                                      ],
                                    ),
                                    loading: () => const LinearProgressIndicator(),
                                    error: (err, _) => Text('Erreur trimestres: $err',
                          ...
                          child: Column(
                            ...
                            children: [
                              TextField(
                                ...
                                style: const TextStyle(color: Colors.white),
                                decoration: const InputDecoration(
                                  labelText: 'Introduction (aperçu visible avant abonnement)',
                              ...
                              Align(
                                ...
                                child: MediaAttachmentPicker(
                                  ...
                                  onChanged: (assets) => attachedIntroMedia = assets,
                                ),
                              ),
                            ],
                          ),
            ...
            ElevatedButton(
              onPressed: isLoading
                  ...
                  : () async {
                      ...
                      if (selectedClassNodeId == null) {
                        setModalState(() => submitError = 'La classe/série est obligatoire.');
                        return;
                      }
                      setModalState(() {
                        submitError = null;
  ...
  Future<void> _previewChapterDraftAsPdf({
    ...
    final draft = Lesson(
      ...
      contentJson: {
        'body': introduction,
        'media': media.map((a) => {'url': a.url, 'filename': a.filename, 'type': a.type}).toList(),
      },
    );
                  ...
                  child: Column(
                    ...
                    children: [
                      Wrap(
                        ...
                        runSpacing: 6,
                        children: [
                          if (className != null) _studentBadge(className, const Color(0xFF1E3A8A)),
                          if (termLabel != null) _studentBadge(termLabel, const Color(0xFF7C3AED)),
                        ],
                      ),
                      const SizedBox(height: 12),
                      Text(
                      ...
                      const SizedBox(height: 12),
                      Text(
                        introduction.isEmpty ? 'Aucune introduction rédigée pour le moment.' : introduction,
  ...
  void _showDuplicateChapterModal(
    ...
    final targets = classOptions.where((c) => c.id != chapter.classNodeId).toList();
    if (targets.isEmpty) {
      showDialog(
        context: context,
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    style: const TextStyle(color: Colors.white),
                    isExpanded: true,
                    decoration: const InputDecoration(labelText: 'Classe / Série cible'),
                    items: targets
                        .map((c) => DropdownMenuItem(value: c.id, child: Text(c.name)))
                        .toList(),
                    onChanged: (v) => setModalState(() => targetClassNodeId = v),
                  ),
                  if (submitError != null) ...[
                    const SizedBox(height: 16),
                    _ErrorBanner(message: submitError!),
              ...
              onPressed: isLoading
                  ...
                  : () async {
                      if (targetClassNodeId == null) {
                        setModalState(() => submitError = 'Sélectionnez une classe cible.');
                        return;
                      }
                      setModalState(() {
                        submitError = null;
                      ...
                      try {
                        ...
                        if (context.mounted) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              backgroundColor: AppTheme.accentEmerald,
                              content: Text('"${chapter.title}" dupliqué avec succès.'),
                            ),
                          );
                        }
                      } catch (e) {
  ...
  void _showDuplicateToTwinGroupModal(BuildContext context, Chapter chapter, TwinGroup twin) {
    final siblings = twin.members.where((m) => m.classNodeId != chapter.classNodeId).toList();
    String? errorText;
    bool isLoading = false;
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: siblings
                      .map((s) => Chip(
                            label: Text(s.className, style: GoogleFonts.inter(fontSize: 11, color: Colors.white)),
                ...
                Consumer(
                  builder: (context, ref, _) {
                    final impactAsync = ref.watch(chapterDuplicationImpactProvider(chapter.id));
            ...
            ElevatedButton.icon(
              ...
              onPressed: isLoading
                  ...
                  : () async {
                      ...
                      try {
                        final service = ref.read(supabaseServiceProvider);
                        final results = await service.duplicateChapterToTwinGroup(chapter.id, _currentAdminId());
                        ref.invalidate(chaptersWithLessonsProvider);
                        if (ctx.mounted) Navigator.pop(ctx);
                        if (context.mounted) {
                          // ignore: use_build_context_synchronously
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              backgroundColor: AppTheme.accentEmerald,
                              content: Text('"${chapter.title}" dupliqué vers ${results.length} classe(s) jumelée(s).'),
                            ),
                          );
                        }
                      } catch (e) {
              ...
              child: Column(
                ...
                children: [
                  TextField(
                    ...
                    style: const TextStyle(color: Colors.white),
                    decoration: const InputDecoration(labelText: 'Nom (ex: Trimestre 1)'),
                  ),
                  const SizedBox(height: 12),
                  TextField(
                    ...
                    children: [
                      Expanded(
                        child: OutlinedButton.icon(
                          ...
                          label: Text(startDate == null ? 'Début' : startDate!.toString().split(' ').first),
                        ),
                      ),
                      const SizedBox(width: 12),
                      Expanded(
                        child: OutlinedButton.icon(
                          ...
                          icon: const Icon(Icons.event_rounded, size: 16),
                          label: Text(endDate == null ? 'Fin' : endDate!.toString().split(' ').first),
                        ),
                      ),
                    ],
                  ),
            ...
            ElevatedButton(
              onPressed: isLoading
                  ...
                  : () async {
                      ...
                      if (name.isEmpty || schoolYear.isEmpty || startDate == null || endDate == null) {
                        setModalState(() => submitError = 'Tous les champs sont obligatoires.');
                        return;
                      }
                      setModalState(() {
                        submitError = null;
  ...
  void _showLessonEditorModal(
    ...
    final contentController =
        TextEditingController(text: existing?.contentJson['body'] as String? ?? '');
    String selectedTier = existing?.minSubscriptionTier ?? 'gratuit';
    List<MediaAsset> attachedMedia = ((existing?.contentJson['media'] as List?) ?? [])
        .map((m) => MediaAsset(
              id: '',
              filename: m['filename'] as String? ?? '',
              type: m['type'] as String? ?? 'document',
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setModalState) {
          ...
          title: AppDialogTitle(
            ...
            text: isEditing ? 'Modifier la Leçon' : 'Éditeur de Leçon (Conforme au Programme)',
            onClose: () => Navigator.pop(ctx),
          ),
          content: SizedBox(
            width: dialogWidth > 1080 ? 1080 : dialogWidth,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                items: const [
                                  DropdownMenuItem(value: 'gratuit', child: Text('Gratuit (Accès libre)')),
                                  DropdownMenuItem(value: 'journalier', child: Text('Journalier (Restreint)')),
                                  DropdownMenuItem(value: 'mensuel', child: Text('Mensuel (Premium)')),
                                ],
                                onChanged: (v) => setModalState(() => selectedTier = v ?? 'gratuit'),
                              ),
                              const SizedBox(height: 16),
                              Text('Contexte', style: GoogleFonts.outfit(fontSize: 12, color: AppTheme.textMuted)),
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    const Icon(Icons.folder_rounded, size: 14, color: AppTheme.accentIndigo),
                                    const SizedBox(width: 8),
                                    Expanded(
                                      child: Text(
                                        resolvedChapterTitle ?? 'Résolution du chapitre…',
                                        overflow: TextOverflow.ellipsis,
                                        style: GoogleFonts.inter(fontSize: 12, color: Colors.white70),
                                      ),
                                    ),
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    const Icon(Icons.menu_book_rounded, size: 14, color: AppTheme.accentBlue),
                                    const SizedBox(width: 8),
                                    Expanded(
                                      child: Text(
                                        resolvedSubjectName ?? 'Résolution de la matière…',
                                        overflow: TextOverflow.ellipsis,
                                        style: GoogleFonts.inter(fontSize: 12, color: Colors.white70),
                                      ),
                                    ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Align(
                                alignment: Alignment.centerLeft,
                                child: OutlinedButton.icon(
                                  style: OutlinedButton.styleFrom(foregroundColor: AppTheme.accentCyan),
                              ...
                              Align(
                                ...
                                child: MediaAttachmentPicker(
                                  ...
                                  onChanged: (assets) => attachedMedia = assets,
                                ),
                              ),
                            ],
                          ),
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              child: isLoading
                  ...
                  : Text(isEditing ? 'Enregistrer les modifications' : 'Enregistrer & Soumettre'),
            ),
          ],
          );
        },
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SizedBox(
          ...
          child: Consumer(
            builder: (context, ref, _) {
              final versionsAsync = ref.watch(lessonVersionsProvider(lesson.id));
                                ...
                                TextButton(
                                  onPressed: () async {
                                    ...
                                    try {
                                      ...
                                      ref.invalidate(chaptersWithLessonsProvider);
                                      ref.invalidate(lessonVersionsProvider(lesson.id));
                                      navigator.pop();
                                      messenger.showSnackBar(
                                        SnackBar(
                                          backgroundColor: AppTheme.accentEmerald,
                                          content: Text('Version ${v.versionNumber} restaurée.'),
                                        ),
                                      );
                                    } catch (e) {
                                      messenger.showSnackBar(
