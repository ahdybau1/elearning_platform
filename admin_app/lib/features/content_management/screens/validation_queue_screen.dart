...
class _ValidationQueueScreenState
    extends ConsumerState<ValidationQueueScreen> {
              ...
              data: (items) {
                ...
                if (filtered.isEmpty) {
                  final emptyLabel = switch (_filterStatus) {
                    ...
                    'a_corriger' => 'Aucun contenu renvoyé en correction pour le moment.',
  ...
  Widget _buildQueueItem(
      ValidationQueueItem item, String reviewerId, List<AdminUser> adminUsers) {
        ...
        children: [
          ...
          if (item.reviewerId != null) ...[
            ...
            Builder(builder: (context) {
              ...
              final reviewerMatches =
                  adminUsers.where((a) => a.id == item.reviewerId);
                  ...
                  if (isSelfApproved) ...[
                    ...
                    Container(
                      ...
                      child: Text(
                        'AUTO-APPROUVÉ',
                        style: GoogleFonts.inter(
                            fontSize: 9, fontWeight: FontWeight.bold, color: AppTheme.accentIndigo),
                      ),
                    ),
                  ],
                ],
    ...
    try {
      if (item.contentType == ContentType.exercise) {
        ...
        await ExercisePdfGenerator.printOrSave(
            exercise: exercise, subjectName: subjectName, chapterTitle: chapterTitle);
      } else {
        final lesson = await service.getLesson(item.contentId);
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            content: Text('Impossible de prévisualiser : $e',
  ...
  Future<void> _approveContent(
      ValidationQueueItem item, String reviewerId) async {
  ...
  void _showDecisionDialog(BuildContext context, ValidationQueueItem item,
      String reviewerId, String decision) async {
    ...
    final decisionColor =
        isReject ? AppTheme.accentRose : AppTheme.accentIndigo;
    String? fieldError;
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                onChanged: (_) {
                  if (fieldError != null) setModalState(() => fieldError = null);
                },
              ),
            ],
          ),
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              if (notes.isEmpty) {
                setModalState(() => fieldError = isReject
              ...
              try {
                final service = ref.read(supabaseServiceProvider);
                if (isReject) {
                  await service.rejectContent(item.id, reviewerId,
                      notes: notes);
                } else {
                  await service.sendBackContent(item.id, reviewerId,
                      notes: notes);
                }
                if (mounted) {
