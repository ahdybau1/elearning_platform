...
class EstablishmentPapersScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EstablishmentPapersScreen> createState() => _EstablishmentPapersScreenState();
}

class _EstablishmentPapersScreenState extends ConsumerState<EstablishmentPapersScreen> {
        ...
        : StudentPageContent(child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Filtrer par établissement', style: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w600, color: Colors.white)),
                  ...
                  establishmentsAsync.when(
                    ...
                    data: (establishments) => SizedBox(
                      ...
                      child: ListView(
                        ...
                        children: [
                          _filterChip('Tous les établissements', _selectedEstablishmentId == null, () => setState(() => _selectedEstablishmentId = null)),
                          ...establishments.map((e) => Padding(
                                padding: const EdgeInsets.only(left: 8),
                                child: _filterChip('${e.name} (${e.city})', _selectedEstablishmentId == e.id, () => setState(() => _selectedEstablishmentId = e.id)),
                              )),
                        ],
                      ),
                    ),
                  ...
                  Expanded(
                    child: Consumer(
                      builder: (context, ref, _) {
                        final papersAsync = ref.watch(establishmentPapersProvider(
                          EstablishmentPapersQuery(classNodeId: profile.classNodeId, establishmentId: _selectedEstablishmentId),
                        ));
                        return papersAsync.when(
                          ...
                          data: (papers) {
                            ...
                            return ListView.separated(
                              ...
                              itemBuilder: (context, index) => _buildPaperTile(context, papers[index]),
                            );
                          },
                        );
                      },
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          if (paper.correctionUrl != null) TextButton(onPressed: () {}, child: const Text('Correction')),
        ],
      ),
    );
  }
