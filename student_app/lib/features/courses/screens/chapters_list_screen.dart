...
class ChaptersListScreen extends ConsumerWidget {
  ...
  Widget _buildHeroBanner(SubjectVisual visual) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: visual.gradient.last.withValues(alpha: 0.3), blurRadius: 20, offset: const Offset(0, 8)),
        ],
      ),
      child: Stack(
        children: [
          Positioned(right: -10, top: -20, child: SubjectMotif(icon: visual.icon, size: 130, opacity: 0.14)),
          Row(
            children: [
              Container(
  ...
  Widget _buildChapterCard(BuildContext context, Chapter chapter, int index, SubjectVisual visual) {
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: isUnlocked ? visual.gradient.first.withValues(alpha: 0.18) : Colors.grey.withValues(alpha: 0.15),
                        ...
                        child: Text(
                          ...
                          style: GoogleFonts.inter(
                            ...
                            color: isUnlocked ? visual.gradient.first : Colors.grey,
                          ),
                        ),
                      ),
                      if (!isUnlocked)
