...
class HomeDashboardScreen extends ConsumerWidget {
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            if (profile != null)
              _buildExamCountdownBanner(ref, profile.classNodeId),
  ...
  Widget _buildWhatsAppCard(
    ...
    return communityAsync.when(
      ...
      error: (err, _) => const SizedBox.shrink(),
      data: (community) {
        // §16 : « Une communauté n'existe qu'à l'initiative de l'admin pays — jamais créée par les
        // élèves. » Aucune ligne pour cette classe → pas de carte plutôt qu'un lien inventé.
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '~${community.memberCountEstimate} membres • Entraide, planning des devoirs et annonces du délégué.',
                      style: GoogleFonts.inter(
                        fontSize: 11,
                        color: const Color(0xFF8AE8B6),
                      ),
                    ),
                  ],
                ),
  ...
  Widget _buildAiTutorSpotlight(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: context.colors.accentCyan.withValues(alpha: 0.4),
        ),
      ),
      child: Row(
        children: [
